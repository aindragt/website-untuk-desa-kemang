...
<div class="admin-card">
    <div class="admin-card__header">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap">
            <form action="{{ route('admin.layanan.index') }}" method="GET" style="display:flex;gap:6px;flex-wrap:wrap">
                ...
                <a href="{{ route('admin.layanan.index') }}" class="btn-sm btn-sm--hapus">Reset</a>
                @endif
            </form>
        </div>
    </div>
