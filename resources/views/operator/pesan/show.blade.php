...
<div style="max-width:640px">
    <div class="admin-card" style="padding:1.75rem">
        ...
        <div style="margin-top:1.5rem;padding-top:1.25rem;border-top:1px solid #e8e4d8;display:flex;gap:0.75rem">
            ...
            {{-- <form action="{{ route('operator.pesan.destroy', $pesan) }}" method="POST" style="margin-left:auto">
                @csrf @method('DELETE')
    ...
    <div style="margin-top:1rem">
        <a href="{{ route('operator.pesan.index') }}" style="font-size:0.82rem;color:var(--teks-muted)">
